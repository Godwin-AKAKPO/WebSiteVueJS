            ...
            <div class="max-w-7x1 mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex flex-col md:flex-row items-center justify-between gap-3 md:gap-6">
                    ...
                    <div class="flex justify-between items-center w-full md:w-auto">
                        ...
                        <button class="md:hidden text-gray-700 hover:text-indigo-600" aria-label="Toogle mobile menu"
                    ...
                    <!-- Search Bar -->
                    <form class="w-full md:flex-1 maw-w-sm " role="search" aria-label="Site search">
                    ...
                    <aside class="flex items-center justify-end space-x-4 w-full md:w-auto">
                        <button class="relative p-2 text-gray-700 hover:text-pink-600" aria-label="Wishlist">
                            ...
                            flex items-center justify-center">3
                            </span>
                        </button>
                        <button class="relative p-2 text-gray-700 hover:text-pink-600" aria-label="Wishlist">
