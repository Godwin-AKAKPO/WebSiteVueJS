    ...
    <section id="home" class="bg-amber-50 scroll-mt-20 py-16">
        <div class="  max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col-reverse lg:flex-row items-center gap-10">
            ...
            <div class="text-center lg:text-left max-w-xl">
                ...
                <div class="flex justity-center lg:justify-start gap-4">
                    <a href="/products"
                    class="px-6 py-3 bg-pink-900 text-white text-sm font-semibold rounded-lg shadow 
                    hover:bg-pink-600 transition"> Shop Now</a>
                    <a href="/products"
                    class="px-6 py-3 border border-pink-500 text-pink-500 text-sm font-semibold rounded-lg shadow 
                    hover:bg-pink-200 transition">View Offers</a>
                </div>
            </div>
            <!-- Right Image  -->
            <div class="w-full lg:w-1/2 flex justify-center">
                <img src="../assets/Capture dՎcran du 2025-07-24 14-26-58.png"  alt="Hero section" class="w-3/4 lg:w-full max-w-md mx-auto rounded-xl shadow-lg">
            </div>
        </div>
